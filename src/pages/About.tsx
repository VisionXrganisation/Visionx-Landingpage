...
import { Award, Target, Heart, Users, Lightbulb, Rocket, Globe, ShieldCheck, Puzzle } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div {...fadeIn} className="space-y-6">
              ...
              <p className="text-xl text-gray-600">
                To be the global leader in educational technology, inspiring and empowering every learner to achieve more.
              </p>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
...
const values = [
  ...
  {
    title: "Collaboration",
    description: "We believe in the power of collaboration to achieve greater results.",
    icon: <Users className="h-8 w-8 text-blue-600" />
  },
  {
    title: "Continuous Learning",
    description: "We are committed to continuous learning and improvement to stay ahead in the ever-evolving education landscape.",
